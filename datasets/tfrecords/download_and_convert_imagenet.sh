...
LABELS_FILE="${WORK_DIR}/datasets/tfrecords/imagenet_lsvrc_2015_synsets.txt"
DOWNLOAD_SCRIPT="${WORK_DIR}/datasets/tfrecords/download_imagenet.sh"
...
PREPROCESS_VAL_SCRIPT="${WORK_DIR}/datasets/tfrecords/preprocess_imagenet_validation_data.py"
VAL_LABELS_FILE="${WORK_DIR}/datasets/tfrecords/imagenet_2012_validation_synset_labels.txt"
...
BOUNDING_BOX_SCRIPT="${WORK_DIR}/datasets/tfrecords/process_bounding_boxes.py"
...
IMAGENET_METADATA_FILE="${WORK_DIR}/datasets/tfrecords/imagenet_metadata.txt"
