...
# Inception V1 model.
# =========================================================================== #
class InceptionV1(abstract_model.Model):
    """Inception 1 model.
    """
    def __init__(self, use_batch_norm):
        self.scope = 'InceptionV1'
        self.use_batch_norm = use_batch_norm
        super(InceptionV1, self).__init__(self.scope, 224, 32, 0.005)

    def forward(self, inputs, num_classes, data_format, is_training):
        sc = inception_v1_arg_scope(
    ...
    with tf.variable_scope(scope, 'InceptionV1', [inputs, num_classes],
        ...
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with tf.variable_scope('Logits'):
                ...
                net = tfx.layers.spatial_mean(net, keep_dims=True, scope='AvgPool_0a_7x7')
