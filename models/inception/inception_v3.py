...
# Inception V3 model.
# =========================================================================== #
class InceptionV3(abstract_model.Model):
    """Inception 3 model.
    """
    def __init__(self):
        self.scope = 'InceptionV3'
        super(InceptionV3, self).__init__(self.scope, 299, 32, 0.005)

    def forward(self, inputs, num_classes, data_format, is_training):
        sc = inception_v3_arg_scope(
        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
            ...
            with tf.variable_scope(end_point):
                ...
                with tf.variable_scope('Branch_3'):
                    ...
                    branch_3 = slim.conv2d(branch_3, depth(64), [1, 1],
                                           scope='Conv2d_0b_1x1')
                net = tfx.layers.concat_channels(
    ...
    with tf.variable_scope(scope, 'InceptionV3', [inputs, num_classes],
        ...
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with tf.variable_scope('Logits'):
                ksize = tfx.layers.ksize_for_squeezing(net, 8)
