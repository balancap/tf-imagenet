...
from deploy import benchmark_storage
from deploy import cnn_util
from deploy import convnet_builder
from deploy import variable_mgr
...
class BenchmarkCNN(object):
  ...
  def __init__(self, params):
    ...
    """
    self.params = params
    subset = 'train' if not params.eval else 'validation'
    self.dataset = datasets.create_dataset(
      self.params.data_dir, self.params.data_name, subset)
